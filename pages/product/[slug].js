...
const [service, setService] = useState()
  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-24 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/71rpZznjrdL._UX569_.jpg" />
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">AGRIMWEAR</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">Wear Code (XL/YELLOW)</h1>
        ...
        <div className="flex">
          <span className="title-font font-medium text-2xl text-gray-900">₹999</span>
          <button className="flex ml-4 text-white bg-yellow-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-yellow-600 rounded">Buy Now!</button>
          <button onClick={() => {addToCart(slug, 1, 999, "Wear Code(L, Red)", 'L', "Red" )}} className="flex ml-4 text-white bg-yellow-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-yellow-600 rounded">Add To Cart</button>
        ...
        <div className="pin mt-6 flex space-x-2 text-sm">
          ...
          <button onClick={checkServiceability} className='flex ml-14 text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded' >Check</button>
        </div>
